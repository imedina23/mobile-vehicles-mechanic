    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(AddUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Response response = _mailHelper.SendMail(model.Username, "Vehicles - Account confirmation", $"<h1>Vehicles - Account confirmation</h1>" +
                    $"To enable the user, " +
                    $"please click the following link: </br></br><a href = \"{tokenLink}\">Confirm Email</a>");
                if (response.IsSuccess)
                {
                    ViewBag.Message = "Instructions to enable your account have been sent to the email.";
                    return View(model);
                }
